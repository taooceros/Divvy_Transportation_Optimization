...
stations_start <- merge(x = stations, y = station_start, by.x = "ID", by.y = "start_station_id")
stations_end <- merge(x = stations, y = station_end, by.x = "ID", by.y = "end_station_id")
stations_total <- rbind(stations_start, stations_end)
rbind(stations_start, stations_end) %>% distinct(ID)
```
